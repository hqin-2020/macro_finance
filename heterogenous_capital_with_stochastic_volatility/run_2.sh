...
# Description: This script solves the model and computes shock elasticities for the two-dimensional economy in Section 4.6 for \rho = 0.67, 1.5 without stochastic volatility.
