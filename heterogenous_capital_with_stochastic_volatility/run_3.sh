                ...
                beta2=${beta2array[$index3]}
                    for gamma in "${gammaarray[@]}"; do
                        for zeta in "${zetaarray[@]}"; do
                            ...
                            if [ -f ./bash/${action_name}/beta1_${beta1}_beta2_${beta2}/kappa_${kappa}_zeta_${zeta}/rho_${rho}_gamma_${gamma}_alpha_${alpha}/Delta_${Delta}.sh ]; then
                                rm ./bash/${action_name}/beta1_${beta1}_beta2_${beta2}/kappa_${kappa}_zeta_${zeta}/rho_${rho}_gamma_${gamma}_alpha_${alpha}/Delta_${Delta}.sh
                            fi

                            mkdir -p ./bash/${action_name}/beta1_${beta1}_beta2_${beta2}/kappa_${kappa}_zeta_${zeta}/rho_${rho}_gamma_${gamma}_alpha_${alpha}/

                            touch ./bash/${action_name}/beta1_${beta1}_beta2_${beta2}/kappa_${kappa}_zeta_${zeta}/rho_${rho}_gamma_${gamma}_alpha_${alpha}/Delta_${Delta}.sh

                            tee -a ./bash/${action_name}/beta1_${beta1}_beta2_${beta2}/kappa_${kappa}_zeta_${zeta}/rho_${rho}_gamma_${gamma}_alpha_${alpha}/Delta_${Delta}.sh <<EOF
#!/bin/bash

#SBATCH --account=pi-lhansen
#SBATCH --job-name=beta1_${beta1}_beta2_${beta2}_gamma_${gamma}_rho_${rho}_kappa_${kappa}_zeta_${zeta}_${action_name}
#SBATCH --output=./job-outs/$job_name/${action_name}/beta1_${beta1}_beta2_${beta2}/kappa_${kappa}_zeta_${zeta}/rho_${rho}_gamma_${gamma}_alpha_${alpha}/Delta_${Delta}.out
#SBATCH --error=./job-outs/$job_name/${action_name}/beta1_${beta1}_beta2_${beta2}/kappa_${kappa}_zeta_${zeta}/rho_${rho}_gamma_${gamma}_alpha_${alpha}/Delta_${Delta}.err
...
EOF
                    sbatch ./bash/${action_name}/beta1_${beta1}_beta2_${beta2}/kappa_${kappa}_zeta_${zeta}/rho_${rho}_gamma_${gamma}_alpha_${alpha}/Delta_${Delta}.sh
                done
            done
        done
    done
